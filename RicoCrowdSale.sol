...
contract RicoCrowdSale {
    ...
    address public stakePoolAddress; // address where LP tokens will be locked
    ...
    function setGeneralInfo(
        ...
        require(_tokenDecimals > 0 && _tokenDecimals <= 18);
    ...
    function getTokenAmount(uint256 _weiAmount)
        ...
        returns (uint256)
    {
        return _weiAmount.mul(10**tokenDecimals).div(tokenPriceInWei);
    }
    ...
    function setPresaleCancelled( bool _presaleCancelled) external onlyPresaleCreatorOrRichFactory {
        ...
        require(block.timestamp >= closeTime, "Presale has already been canceled");
        presaleCancelled = _presaleCancelled;
    }

    function setLiquidityAdded(bool _cakeLiquidityAdded ) external onlyRichFactory {
        cakeLiquidityAdded = _cakeLiquidityAdded;
    }
